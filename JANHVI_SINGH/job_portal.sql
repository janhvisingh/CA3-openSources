...
INSERT INTO `job_portal` (`id`, `title`, `blurb`, `url`, `keywords`) VALUES
...
(4, 'java developer', 'java development to create or manage website or projects', 'https://www.naukri.com/tcs-java-jobs', 'java coding javascript');
